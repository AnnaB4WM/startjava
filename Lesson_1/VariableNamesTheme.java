public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        String mathExpression = "Два плюс два равно четыре";
        System.out.println("математическое выражение = " + mathExpression);

        // выбор (чего-либо)
        String pick = "машина";
        System.out.println("выбор (чего-либо) - " + pick);
        ...
        int maxStringLeight = 5;
        System.out.println("максимальная длина (строки) = " + maxStringLeight);

        // пункт меню
        String menuOption = "Мясо";
        ...
        int hddVolume = 3;
        System.out.println("емкость жесткого диска = " + hddVolume);
